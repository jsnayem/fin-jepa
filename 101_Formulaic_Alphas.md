...
certain stock (or other instrument) holdings by some times (e.g., a tickers by holdings matrix for each ).
(cid:1) , (cid:1) ,… (cid:1)
(cid:2) (cid:4) (cid:6)
...
wise correlation of these alphas is low, 15.9% (14.3%). The returns are strongly correlated
(cid:7)
with the volatility , and as in [Kakushadze and Tulchinsky, 2015] we find an empirical scaling
(cid:8)
(cid:11)
(cid:7) ~ (cid:8) (1)
with for our 101 alphas. Furthermore, we find that the returns have no significant
(cid:15) ≈ 0.76
dependence on the turnover . This is a direct confirmation of an earlier result by [Kakushadze
(cid:21)
...
covariance matrix via a factor model.8 A more precise statement is that pair-wise correlations
of the alphas ( label the alphas, ) are not highly correlated with the
(cid:22) (cid:25),(cid:26) = 1,…,(cid:28) (cid:28) (cid:25) ≠ (cid:26)
(cid:23)(cid:24)
product , where , and is an a priori arbitrary normalization constant.9
ln( ) ln( ) = (cid:21) / " "
(cid:23) (cid:24) (cid:23) (cid:23)
...
distribution, while pair-wise correlations take values in (in fact, their distribution is tighter – see below).
(−1,1)
3
...
subsequent to the date of the most recent data used in computing it. A “delay- ” alpha is
2
defined similarly, with counting the number of days by which the data used is out-of-sample.
2
...
3.
Data and Empirical Properties of Alphas
...
|                           | 4   |     |                              |                   | (cid:25)	((cid:25) = 1,…,(cid:28)) | (cid:28) = | 101 |     |     |
| ------------------------- | --- | --- | ---------------------------- | ----------------- | ---------------------------------- | ---------- | --- | --- | --- |
| alphas.  For each alpha,  |     |     | ,   and                      |  are defined via  |                                    |            |     |     |     |
|                           |     | 3   | (cid:23) (cid:21) (cid:23) 4 | (cid:23)          |                                    |            |     |     |     |
|                           |     |     |                              |                   | 7 (cid:23)                         |            |     |     |     |
																																																																										3 = √252	 																																																																			(4)
(cid:23)
(cid:8)
...
(cid:23)
; (cid:23)
Here:   is the average daily P&L (in dollars);   is the daily portfolio volatility;   is the average
|     | 7        |     |     |     | (cid:8)  |     | ;        |     |     |
| --- | -------- | --- | --- | --- | -------- | --- | -------- | --- | --- |
|     | (cid:23) |     |     |     | (cid:23) |     | (cid:23) |     |     |
daily shares traded (buys plus sells) by the  -th alpha;   is the average daily dollar volume
(cid:25) 9
(cid:23)
traded; and   is the total dollar investment in said alpha (the actual long plus short positions,
: (cid:23)
without leverage).  More precisely, the principal of   is constant; however,   fluctuates due to
|     |     |     |     |     | :        |     | :        |     |     |
| --- | --- | --- | --- | --- | -------- | --- | -------- | --- | --- |
|     |     |     |     |     | (cid:23) |     | (cid:23) |     |     |
the daily P&L.  So, both  and  are adjusted accordingly (such that  is constant) in Equation
|     |     | 9   | :                   |     |     | :         |     |     |     |
| --- | --- | --- | ------------------- | --- | --- | --------- | --- | --- | --- |
|     |     |     | (cid:23)	 (cid:23)	 |     |     | (cid:23)	 |     |     |     |
(4).  The period of time over which this data is collected is Jan 4, 2010-Dec 31, 2013.  For the
same period we also take the sample covariance matrix   of the realized daily returns for our
<
(cid:23)(cid:24)
alphas.  The number of observations in the time series is 1,006, and   is nonsingular.  From
|     |     |     |     |     |     | < (cid:23)(cid:24) |     |     | < (cid:23)(cid:24) |
| --- | --- | --- | --- | --- | --- | ------------------ | --- | --- | ------------------ |
we read off the daily return volatility   and the correlation matrix
|     |     |     |     | = (cid:4) =	< |                  |     | (cid:22) =	<     | 	/	=	=           |                   |
| --- | --- | --- | --- | ------------- | ---------------- | --- | ---------------- | ---------------- | ----------------- |
|     |     |     |     | (cid:23)      | (cid:23)(cid:23) |     | (cid:23)(cid:24) | (cid:23)(cid:24) | (cid:23) (cid:24) |
, and the average14 daily return is given by
| (where  |            |   Note that  |               |     |     |     |         |     | .   |
| ------- | ---------- | ------------ | ------------- | --- | --- | --- | ------- | --- | --- |
|         | (cid:22) = | 1).          | (cid:8) = =	: |     |     |     | (cid:7) | = 7 | /	: |
(cid:23)(cid:23) (cid:23) (cid:23) (cid:23) (cid:23) (cid:23)	 (cid:23)
Table 1 and Figure 1 summarize the data for the annualized Sharpe ratio  , daily turnover,
3
(cid:23)
, average holding period  , cents-per-share  , daily return volatility  , annualized
(cid:21) (cid:23) 1	/	(cid:21) (cid:23) 4 (cid:23) = (cid:23)
average daily return  , and   pair-wise correlations   with  .
|     |     | (cid:7)> = | 252	(cid:7) | (cid:28)((cid:28)−1)/2 |     |     | (cid:22)         | (cid:25) > (cid:26) |     |
| --- | --- | ---------- | ----------- | ---------------------- | --- | --- | ---------------- | ------------------- | --- |
|     |     | (cid:23)   | (cid:23)    |                        |     |     | (cid:23)(cid:24) |                     |     |
3.1. Return v. Volatility & Turnover
We run two cross-sectional regressions, both with the intercept, of   over i)   as
|     |     |     |     |     |     | ln((cid:7) | )        | ln(=) |          |
| --- | --- | --- | --- | --- | --- | ---------- | -------- | ----- | -------- |
|     |     |     |     |     |     |            | (cid:23) |       | (cid:23) |
the sole explanatory variable, and ii) over   and  .  The results are summarized in
|     |     |     |     |     | ln(=) ln((cid:21)) |     |     |     |     |
| --- | --- | --- | --- | --- | ------------------ | --- | --- | --- | --- |
(cid:23) (cid:23)
...
significant dependence on the turnover   here, while the average daily return   is strongly
|     |     | (cid:21) |          |     |     | (cid:7)  |     |
| --- | --- | -------- | -------- | --- | --- | -------- | --- |
|     |     |          | (cid:23) |     |     | (cid:23) |     |
correlated with the daily return volatility   and we have the scaling property (1) with  .
|     |     |     | =   |     |     | (cid:15) | ≈ 0.76 |
| --- | --- | --- | --- | --- | --- | -------- | ------ |
(cid:23)
...
(cid:4)
																																																																@ = A 	B + D E 	J 	E 																																														(7)
|     |     | (cid:23)(cid:24) | (cid:23) (cid:23)(cid:24) | (cid:23)F | FH (cid:24)H |     |     |
| --- | --- | ---------------- | ------------------------- | --------- | ------------ | --- | --- |
F,HI(cid:2)
Here:  (cid:4) is the specific risk;   is an   factor loadings matrix corresponding to   risk
| A        |     | E (cid:28)×L |     |     |     | L ≪ | (cid:28) |
| -------- | --- | ------------ | --- | --- | --- | --- | -------- |
| (cid:23) |     | (cid:23)F    |     |     |     |     |          |
factors; and   is a factor covariance matrix.  In our case, we are interested in modeling the
J
FH
correlation matrix   and ascertaining whether the turnover has explanatory power for pair-
(cid:22)
(cid:23)(cid:24)
wise correlations.  Whether the volatility and turnover are correlated is a separate issue.
So, our approach is to take one of the columns of the factor loadings matrix as  .  More
ln((cid:21)) (cid:23)
precisely, a priori there is no reason why we should pick  as opposed to  , where
|     |     |     |     | 	ln((cid:21)) |          | ln(  )   |     |
| --- | --- | --- | --- | ------------- | -------- | -------- | --- |
|     |     |     |     |               | (cid:23) | (cid:23) |     |
, and   is some normalization factor.  To deal with this, let us normalize   such that
|   (cid:23) = (cid:21)	/	" (cid:23) | "   |     |     |     |     |   (cid:23) |     |
| ---------------------------------- | --- | --- | --- | --- | --- | ---------- | --- |
 has zero cross-sectional mean, and let   be the unit  -vector (the intercept).  Then
| ln(  )                                                |                                         |     | N = 1    |                  | (cid:28)                                     |                   |          |
| ----------------------------------------------------- | --------------------------------------- | --- | -------- | ---------------- | -------------------------------------------- | ----------------- | -------- |
| (cid:23)                                              |                                         |     | (cid:23) |                  |                                              |                   |          |
| we can construct three symmetric tensor combinations  |                                         |     |          |                  | ,                                            |                   | ,        |
|                                                       |                                         |     |          | O =              | N N P = N 	lnQ                               | R+N 	ln(          | )        |
|                                                       |                                         |     |          | (cid:23)(cid:24) | (cid:23)	 (cid:24) (cid:23)(cid:24) (cid:23) | (cid:24) (cid:24) | (cid:23) |
| and                                                   | .  Let us now define a composite index  |     |          |                  |                                              | , which takes     |          |
S = ln(  )	lnQ  R TUV = T((cid:25),(cid:26))|(cid:25) > (cid:26)V
| (cid:23)(cid:24) | (cid:23) (cid:24) |     |     |     |     |     |     |
| ---------------- | ----------------- | --- | --- | --- | --- | --- | --- |
 values, i.e., we pull the off-diagonal lower-triangular elements of a general
X = 	(cid:28)((cid:28)−1)/2
...
symmetric matrix   into a vector  .  This way we can construct four  -vectors  ,     and
|     |     | Y                | Y   |     |     | X   | (cid:22) | O ,P  |
| --- | --- | ---------------- | --- | --- | --- | --- | -------- | ----- |
|     |     | (cid:23)(cid:24) | Z   |     |     |     |          | Z Z Z |
.  Now we can run a linear regression of   over     and  .  Note that   is simply
| S   |     |     |     | (cid:22) | O ,P S |     | O = 	1 |     |
| --- | --- | --- | --- | -------- | ------ | --- | ------ | --- |
| Z   |     |     |     | Z        | Z Z Z  |     | Z      |     |
the intercept (the unit  -vector), so this is a regression of   over   and   with the intercept.
|     |     | X   |     |     | (cid:22) P |     | S   |     |
| --- | --- | --- | --- | --- | ---------- | --- | --- | --- |
|     |     |     |     |     | Z          | Z   | Z   |     |
The results are summarized in Table 4.  It is evident that the linear and bilinear (in  )
|     |     |     |     |     |     |     | ln(  | )   |
| --- | --- | --- | --- | --- | --- | --- | ---- | --- |
(cid:23)
variables    and   have poor explanatory power for pair-wise correlations  , while   (the
|     | P Z | S Z |     |     |     |     | (cid:22) Z | O Z |
| --- | --- | --- | --- | --- | --- | --- | ---------- | --- |
intercept) simply models the average correlation  .  Recall that by construction   and
|     |     |     |     |     | Mean((cid:22) ) |     |     | P   |
| --- | --- | --- | --- | --- | --------------- | --- | --- | --- |
|     |     |     |     |     | Z               |     |     | Z   |
 are orthogonal to  , and these three explanatory variables are independent of each other.
| S   |     | O   |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Z   |     | Z   |     |     |     |     |     |     |
...
regression of   over   (with the intercept) shows nonzero correlation between these
|     | ln(=) | ln((cid:21)) |     |     |     |     |     |     |
| --- | ----- | ------------ | --- | --- | --- | --- | --- | --- |
...
factor loadings matrix corresponding to the turnover is no longer proportional to   but is a more complex
ln(  )
(cid:23)
function of the turnover, the specific risk also depends on the turnover nontrivially and is not quadratic in
ln(  ).
|     |     |     |     |     |     |     |     | (cid:23) |
| --- | --- | --- | --- | --- | --- | --- | --- | -------- |
...
|     |     | 1.238  | 1.929  |     | 2.224  | 2.265  | 2.498  | 4.162  |
| --- | --- | ------ | ------ | --- | ------ | ------ | ------ | ------ |
3
|     |     | 0.1571  | 0.3429  |     | 0.4752  | 0.5456  | 0.6474  | 1.604  |
| --- | --- | ------- | ------- | --- | ------- | ------- | ------- | ------ |
(cid:21)
|     |     | 0.6235  | 1.545  |     | 2.104  | 2.391  | 2.916  | 6.365  |
| --- | --- | ------- | ------ | --- | ------ | ------ | ------ | ------ |
1	/	(cid:21)
|     |     | 0.1324  | 0.3125  |     | 0.3969  | 0.4814  | 0.5073  | 2.031  |
| --- | --- | ------- | ------- | --- | ------- | ------- | ------- | ------ |

4
|     |     | 0.9318  | 1.194  |     | 1.395  | 1.747  | 2.019  | 10.44  |
| --- | --- | ------- | ------ | --- | ------ | ------ | ------ | ------ |
\
10 	×=
|     |     |   3.285  | 4.4  |     | 5.441  | 6.015  | 6.296  | 28.72  |
| --- | --- | -------- | ---- | --- | ------ | ------ | ------ | ------ |
100%	×(cid:7)>
|                |     |   -15.09         | 7.457  |     | 14.31  | 15.86  | 22.91  | 87.33  |
| -------------- | --- | ---------------- | ------ | --- | ------ | ------ | ------ | ------ |
| 100%	×(cid:22) |     | (cid:23)(cid:24) |        |     |        |        |        |        |
Table 1. Summary (using the R function summary()) for the annualized Sharpe ratio  , daily
3
(cid:23)
turnover,  , average holding period  , cents-per-share  , daily return volatility  ,
(cid:21) (cid:23) 1	/	(cid:21) (cid:23) 4 (cid:23) = (cid:23)
annualized average daily return  (cid:7)> , and pair-wise correlations   with   (see Section 3).
...
of   over   with the intercept.  See Subsection 3.1 for details.  Also see Figure 2.
| ln((cid:7)) |     | ln(=) |     |     |     |     |     |     |
| ----------- | --- | ----- | --- | --- | --- | --- | --- | --- |
...
| --------------------- | --- | --- | --- | --- | --- | --- | -------------- | --- |
| F-statistic           |     |     |     |     |     |     | 137.8          |     |
Table 3. Summary for the cross-sectional regression of   over   and   with the
|     |     |     |     |     |     | ln((cid:7)) | ln(=) | ln((cid:21)) |
| --- | --- | --- | --- | --- | --- | ----------- | ----- | ------------ |
...
| --------------------- | --- | --- | --- | --- | --- | --- | ---------------- | --- |
| F-statistic           |     |     |     |     |     |     | 32.55            |     |
Table 4. Summary for the cross-sectional regression of   over   and   with the intercept.
|     |     |     |     |     |     | (cid:22) | P S |     |
| --- | --- | --- | --- | --- | --- | -------- | --- | --- |
|     |     |     |     |     |     | Z        | Z Z |     |
...
| --------------------- | --- | --- | --- | --- | -------------- |
| F-statistic           |     |     |     |     | 29.29          |
Table 5. Summary for the cross-sectional regression of   over   with the intercept.  See
|     |     |     |     | ln(=) | ln((cid:21)) |
| --- | --- | --- | --- | ----- | ------------ |
...
Figure 1. Density (using the R function density()) plots for the annualized Sharpe ratio  ,
3
(cid:23)
daily turnover,  , cents-per-share  , daily return volatility  , annualized average daily return
|     | (cid:21) (cid:23) |     | 4 (cid:23) | = (cid:23) |     |
| --- | ----------------- | --- | ---------- | ---------- | --- |
, and pair-wise correlations   with   (see Table 1 and Section 3).  The “extreme” outliers
| (cid:7)> |     | (cid:22) | (cid:25) > (cid:26) |     |     |
| -------- | --- | -------- | ------------------- | --- | --- |
| (cid:23) |     |          | (cid:23)(cid:24)    |     |     |
 are due to the delay-0 alphas (see Section 2).
| in  ,   and           | (cid:7)> |     |     |     |     |
| --------------------- | -------- | --- | --- | --- | --- |
| 3 (cid:23) = (cid:23) | (cid:23) |     |     |     |     |
19

Figure 2. Horizontal axis: ; vertical axis: . The dots represent the data points. The
ln(=) ln((cid:7))
straight line plots the linear regression fit . See Table 2.
ln((cid:7)) ≈ −3.509 + 0.761 ln(=)
20

| Figure 3. Horizontal axis:  |              |            | ; vertical axis:  |                         | .  See  |
| --------------------------- | ------------ | ---------- | ----------------- | ----------------------- | ------- |
|                             | _ = 0.0067	P | +	0.0474	S |                   | (cid:22) −Mean((cid:22) | )       |
|                             | Z            | Z          | Z                 | Z                       | Z       |
Table 4 and Subsection 3.2.  The numeric coefficients are the regression coefficients in Table 4.
21

Figure 4. Horizontal axis: ; vertical axis: . The dots represent the data points. The
ln((cid:21)) ln(=)
straight line plots the linear regression fit . See Table 5.
ln(=) ≈ −6.174+ 0.368 ln((cid:21))
22